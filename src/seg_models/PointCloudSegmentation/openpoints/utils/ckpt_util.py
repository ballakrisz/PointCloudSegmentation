...
def save_checkpoint(cfg, model, epoch, optimizer=None, scheduler=None,
    ...
    current_pretrained_path = os.path.join("/home/appuser/checkpoints/PointCloudSegmentation/", current_ckpt_name)
    save_dict = {
    ...
    if is_best:
        ...
        # best_pretrained_path = os.path.join("/home/appuser/checkpoints/PointCloudSegmentation/", best_ckpt_name)
