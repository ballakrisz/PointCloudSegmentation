...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        writer.add_scalar("Train Loss", loss.item(), epoch)  # Logging loss of last batch
        ...
        writer.add_scalar("Class Avg IoU", test_metrics['class_avg_iou'], epoch)
        writer.add_scalar("Instance Avg IoU", test_metrics['inctance_avg_iou'], epoch)
